...
const FAQS = [
  ...
  { q: 'What file types are supported?', a: 'Cadence supports PDF, DOCX, PNG, and JPG contracts and invoices, including OCR for scanned documents.' },
  ...
  { q: 'How does the tone scale work?', a: 'The 0–100 scale moves through ten named anchors from Humble to Strict & Formal. Cadence recommends a starting point based on the relationship, payment behavior, and urgency, and you can override it.' },
